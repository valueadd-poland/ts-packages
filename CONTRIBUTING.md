...
## Developing for TS Packages

The most important part, to add any value to TS Packages you have to follow up this list.
...
5. Submit the branch as a PR to relevant TS Packages repository.
